...
#fila_1_m = MAP([S3,S2,S1])(fila_1_t)
...
west = T([1])([53])(east)
#STRUCT([floor_0, T([2])([9.93])(floor_1),T([2])([9.93+8.83])(floor_2),T([2])([9.93+(8.83*2)])(floor_3),T([2])([9.93+(8.83*3)])(floor_4),T([2])([9.93+(8.83*4)])(floor_5)]) 

build_r = R([2,3])(-PI/2)(building)

strutt = STRUCT([north,build_r,south, east, west])
